...
#         B = a.to_layout_tensor().shape[0]()
#         D = b.to_layout_tensor().shape[1]()

#         alias a_layout = a.
#         alias b_layout = b.to_layout_tensor().layout
#         alias out_loss_layout = out_loss.to_layout_tensor().layout
#         alias out_grad_layout = out_grad.to_layout_tensor().layout
...
#         var kernel_func = gpu_ctx.compile_function_checked[kernel, kernel]()


#         gpu_ctx.enqueue_function_checked(kernel_func, 
#             a,
#             b,
#             out,
#             out_grad,
...
#             block_dim=(32, 32),
#         )
#         print("a_layout:", a_layout.layout)
#         print("a_layout.layout:", a_layout.layout)
